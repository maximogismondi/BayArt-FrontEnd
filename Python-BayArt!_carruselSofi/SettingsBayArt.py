...
#Recuadro
divPhotos = Frame(root, bg="#3d3d3d", width=int(rootWidth/1.2), height=int(rootHeight/3.5))
...
def resizeImage(urlImage):
    ...
    if(rootWidth / width < rootHeight / height):
        image_resized = image_no_resized.resize((int(rootWidth/5.5),int((height/width)*(rootWidth/5.5))),Image.ANTIALIAS)
    else:
        image_resized = image_no_resized.resize((int((width/height)*(rootHeight/5.5)),int(rootHeight/5.5)),Image.ANTIALIAS)
...
buttondisable1 = Button (root, image=show_image, border=0, bg = "#3d3d3d", activebackground="#3d3d3d" , command=disableEnable1)
...
buttondisable2 = Button (root, image=show_image, border=0, bg = "#3d3d3d", activebackground="#3d3d3d", command=disableEnable2)
...
buttondisable3 = Button (root, image=show_image, border=0, bg = "#3d3d3d", activebackground="#3d3d3d", command=disableEnable3)
...
buttondisable4 = Button (root, image=show_image, border=0, bg = "#3d3d3d", activebackground="#3d3d3d", command = disableEnable4)
...
checkBoxInfo = Checkbutton(variable=checkBoxInfoVar, text="Show Information",font=("Verdana", 20, "bold"),bg="#242424", fg="#7c7c7c", activebackground="#242424", activeforeground="white")
checkBoxInfo.place(relx = 0.15, rely = 0.7, anchor = CENTER)

#Auto-rotate
checkBoxRotateVar = BooleanVar()
checkBoxRotate = Checkbutton(variable=checkBoxRotateVar, text="Auto Rotate",font=("Verdana", 20, "bold"),bg="#242424",fg="#7c7c7c", activebackground="#242424", activeforeground="white")
checkBoxRotate.place(relx = 0.35, rely = 0.7, anchor = CENTER)

#Time-Rotation
timeRotation=Label(root,text="Time Rotation (seg):",font=("Verdana", 20, "bold"),bg="#242424",fg="#7c7c7c",highlightthickness = 0, activebackground="#242424", bd = 0)
timeRotation.place(relx = 0.55, rely = 0.7, anchor = CENTER)
timeRotationSB=Spinbox(root, width=5, bg="#242424", font=("Verdana", 20, "bold"), fg="#7c7c7c", from_=5, to=300)
...
playButton = Button(text="Play",font=("Verdana", 15, "bold"), command=openCarrousel ,width=int(rootWidth/113.33), height=2, bg="#00a797", fg="#242424" , activebackground="#674ea7", bd=0)
...
button_close = Button(root, command=root.destroy, image=close_image,highlightthickness = 0,bg="#242424", activebackground="#242424", bd = 0)
