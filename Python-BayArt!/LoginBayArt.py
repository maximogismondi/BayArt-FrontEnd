...
#Login
#Recuadro
divLogin = Frame(root, bg="#3d3d3d", width=int(rootWidth/2.25), height=int(rootHeight/2.25))
divLogin.place(relx = 0.5, rely = 0.6, anchor = CENTER)


#Username
usernameLabel=Label(root,text="Username", font=("Verdana", 20, "bold"), bg="#3d3d3d", fg="white")
usernameEntry = Entry(root, width=int(rootWidth/44.21), font=("Verdana", 15, "bold"), bg="#7c7c7c", fg="white", bd=0)
...
#Password
passwordLabel=Label(root,text="Password", font=("Verdana", 20, "bold"), bg="#3d3d3d", fg="white")
passwordEntry = Entry(root, width=int(rootWidth/44.21), font=("Verdana", 15, "bold"), show="*", bg="#7c7c7c", fg="white", bd=0)
...
logInButton = Button(text="LogIn",font=("Verdana", 15, "bold"), command=openSettings ,width=int(rootWidth/113.33), height=2, bg="#00a797", fg="#242424" , activebackground="#674ea7", bd=0)
...
button_close = Button(root, command=openSettings, image=close_image,highlightthickness = 0,bg="#242424", activebackground="#242424", bd = 0)
