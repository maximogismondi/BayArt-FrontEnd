...
if infoEnable == 'True':
        ...
        artistLabel=Label(root,text="ArtistName", font=("Verdana", 12, "bold"), bg="#3d3d3d", fg="white")
        artistLabel.place(relx = 0.5, rely = 0.08, anchor = CENTER)

        pictureNameLabel=Label(root,text="PictureName", font=("Verdana", 30, "bold"), bg="#3d3d3d", fg="white")
        pictureNameLabel.place(relx = 0.5, rely = 0.035, anchor = CENTER)
